...
int main() {
  ...
  while (T--) {
    ...
    if (countOne == 0)
      ...
      if ((str[0] == 'X' && str[6] == 'X') || (str[1] == 'X' && str[7] == 'X') || (str[2] == 'X' && str[8] == 'X') ||
          (str[3] == 'X' && str[9] == 'X') || (str[4] == 'X' && str[10] == 'X') || (str[5] == 'X' && str[11] == 'X')) {
        f2 = true;
        total++;
      }
      if ((str[0] == 'X' && str[4] == 'X' && str[8] == 'X') || (str[1] == 'X' && str[5] == 'X' && str[9] == 'X') ||
          (str[2] == 'X' && str[6] == 'X' && str[10] == 'X') || (str[3] == 'X' && str[7] == 'X' && str[11] == 'X')) {
        f3 = true;
        total++;
      }

      if ((str[0] == 'X' && str[3] == 'X' && str[6] == 'X' && str[9] == 'X') ||
          (str[1] == 'X' && str[4] == 'X' && str[7] == 'X' && str[10] == 'X') ||
